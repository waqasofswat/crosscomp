...
class PopUpMedicalHistory extends StatefulWidget {
  final Function() pressYes;
  final Function() pressNo;
  PopUpMedicalHistory({required this.pressNo, required this.pressYes});

  @override
  _PopUpMedicalHistoryState createState() => _PopUpMedicalHistoryState();
}

class _PopUpMedicalHistoryState extends State<PopUpMedicalHistory>
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: getProportionateScreenHeight(5)),
                        Text(
                          "Cardic Catheterization or Angioplasty",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: getProportionateScreenWidth(15),
                            color: Colors.black87,
                        ...
                        SizedBox(height: getProportionateScreenHeight(5)),
                        Text(
                          "Pacemaker, Defibrillator, or Dynsrhythmia",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: getProportionateScreenWidth(15),
                            color: Colors.black87,
