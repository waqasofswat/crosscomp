...
class PersonalChallengeScore extends StatefulWidget {
  PersonalChallengeScore({Key? key}) : super(key: key);

  @override
  _PersonalChallengeScoreState createState() => _PersonalChallengeScoreState();
}

class _PersonalChallengeScoreState extends State<PersonalChallengeScore> {
