...
class PeerTeamChallengeScore extends StatefulWidget {
  PeerTeamChallengeScore({Key? key}) : super(key: key);

  @override
  _PeerTeamChallengeScoreState createState() => _PeerTeamChallengeScoreState();
}

class _PeerTeamChallengeScoreState extends State<PeerTeamChallengeScore> {
  final GlobalKey<AnimatedListState> listKeyK = GlobalKey<AnimatedListState>();
  List<Map<String, dynamic>> _cocaptains = [
    {"name": "High School", "total_scores": "112.2", "isGreen": false},
    {"name": "BreckenFit", "total_scores": "109.3", "isGreen": true},
    {"name": "Low Score", "total_scores": "67.6", "isGreen": false},
    {"name": "Placement", "total_scores": "3rd", "isGreen": true},
    {"name": "Percentile", "total_scores": "88.2", "isGreen": true},
  ];
