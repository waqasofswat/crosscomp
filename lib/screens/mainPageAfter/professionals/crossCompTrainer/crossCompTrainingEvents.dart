...
class CrossCompTrainingEvents extends StatefulWidget {
  CrossCompTrainingEvents({Key? key}) : super(key: key);

  @override
  _CrossCompTrainingEventsState createState() =>
      _CrossCompTrainingEventsState();
}

class _CrossCompTrainingEventsState extends State<CrossCompTrainingEvents> {
        ...
        child: InkWell(
          onTap: (){
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => EventTraineeSchedule(eventId: item["id"].toString(),)));
          },
          child: Padding(
