...
import 'package:cross_comp/screens/mainPageAfter/professionals/events/eventExerciseRx.dart';
import 'package:cross_comp/screens/mainPageAfter/professionals/events/eventScores.dart';
import 'package:cross_comp/utilities/constants.dart';
import 'package:cross_comp/utilities/size_config.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

import 'eventTraineeSchedule.dart';

class EventTraineeCheckIn extends StatefulWidget {
  String userId;
  String rId;
  String eventId;
  EventTraineeCheckIn({Key? key,required this.userId,required this.rId,required this.eventId}) : super(key: key);

  @override
  _EventTraineeCheckInState createState() => _EventTraineeCheckInState();
}

class _EventTraineeCheckInState extends State<EventTraineeCheckIn> {
  String fName = "Jon";
  String lName = "Opsahl";
    ...
    if (response.statusCode == 200) {
      if (response.body.toString().contains("Failure")) {
        ...
        if (map['status'] == "failed") {
          ...
          setState(() {
            isLoading = false;
            MaterialPageRoute(builder: (context) => EventTraineeSchedule(eventId: widget.eventId));
                  ...
                  child: DefaultButton(
                      ...
                      press: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => EventExerciseRx()));
                      },
                      clr: kPrimaryColor,
                      isInfinity: true),
                ),
