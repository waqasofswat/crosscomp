...
import 'package:cross_comp/screens/mainPageAfter/professionals/events/eventRecruitScreen.dart';
import 'package:cross_comp/utilities/constants.dart';
import 'package:cross_comp/utilities/size_config.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class EventJudgeSchedule extends StatefulWidget {
  String eid;
  EventJudgeSchedule({Key? key,required this.eid}) : super(key: key);

  @override
  _EventJudgeScheduleState createState() => _EventJudgeScheduleState();
}

class _EventJudgeScheduleState extends State<EventJudgeSchedule> {
            ...
            try{
              ...
              //  String isFree=map['server_response'][i]['judges_appointments']['isFree'].toString();
                ...
                if(indeX!=-1){
                  ...
                  _part.add([{"names": name,"id": rid, "uid": uid, "status": false}]);
                }
      ...
      child: GestureDetector(
        ...
        child: Container(
            ...
            child: Column(
              children: [
                newMethodEvent(
                    item["timing"].toString(), item["participant"].toString()),
                Container(
  ...
  Container newMethodEvent(String timingText, String participantText) {
    return Container(
