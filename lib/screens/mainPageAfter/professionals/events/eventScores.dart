...
class EventScores extends StatefulWidget {
  EventScores({Key? key}) : super(key: key);

  @override
  _EventScoresState createState() => _EventScoresState();
}

class _EventScoresState extends State<EventScores> {
