...
import 'package:cross_comp/screens/mainPageAfter/professionals/events/eventRegistration.dart';
...
_timimg.clear();
  ...
  Future<Map<String, dynamic>> deleteEventData(String Event_ID) async {
    print("saveEventData");


    String url = mainApiUrl + "?delete_event=true&Event_ID=$Event_ID";
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    deleteEventData(item["id"].toString());
                  },
                  child: Image.asset(
                ...
                child: DefaultButton(
                    ...
                    press: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => EventResgistration()));
                    },
                    clr: kTextGreenColor,
                    isInfinity: true),
              )
