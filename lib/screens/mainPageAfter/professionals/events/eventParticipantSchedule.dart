...
import 'eventCheckIn.dart';
import 'package:http/http.dart' as http;

class EventParticipantSchedule extends StatefulWidget {
  final String eventId;
  EventParticipantSchedule({required this.eventId}) ;

  @override
  _EventParticipantScheduleState createState() =>
      _EventParticipantScheduleState();
}

class _EventParticipantScheduleState extends State<EventParticipantSchedule> {
                ...
                onTap: () {
                  if(item["checkIn"].toString()=="0"){
                    ...
                    Navigator.pushReplacement(context,
                        MaterialPageRoute(builder: (context) => EventCheckIn(userId: item["uid"].toString(),rId: item["id"].toString(),)));
                  }
                },
