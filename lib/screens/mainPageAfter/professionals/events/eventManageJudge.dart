...
import 'package:cross_comp/screens/mainPageAfter/professionals/events/selectEvent.dart';
import 'package:cross_comp/utilities/constants.dart';
import 'package:cross_comp/utilities/size_config.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class EventManageJudge extends StatefulWidget {
  EventManageJudge({Key? key}) : super(key: key);

  @override
  _EventManageJudgeState createState() => _EventManageJudgeState();
}

class _EventManageJudgeState extends State<EventManageJudge> {
  ...
  Future<Map<String, dynamic>> getJudgesData() async {
    ...
    _timimg.clear();
    String url = mainApiUrl + "?get_all_professional_volunteer_judges=true&type=event";
