...
import 'package:cross_comp/screens/mainPageAfter/professionals/events/eventJudgeSchedule.dart';
...
class SelectEvent extends StatefulWidget {
  SelectEvent({Key? key}) : super(key: key);
...
class _SelectEventState extends State<SelectEvent> {
  ...
  Future<Map<String, dynamic>> getEventData() async {
    ...
    _timimg.clear();
    String url = mainApiUrl + "?get_all_event=true&isFree=0";
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => EventJudgeSchedule(eid: item["id"].toString() ,)));
          },
          child: Padding(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: GestureDetector(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => SelectEvent()));
          },
          child: Text(
            "Select Event",
