...
import 'package:cross_comp/screens/mainPageAfter/professionals/facilities/facilityCheckIn.dart';
...
class FacilityParticipantSchedule extends StatefulWidget {
  final String facilityId;
  FacilityParticipantSchedule({required this.facilityId}) ;

  @override
  _FacilityParticipantScheduleState createState() =>
      _FacilityParticipantScheduleState();
}

class _FacilityParticipantScheduleState
    extends State<FacilityParticipantSchedule> {
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FacilityCheckIn(userId: item["uid"].toString(),rId:  item["rid"].toString(),)));
                  }
                },
                child: Text(
                  item["names"].toString(),
