...
import 'package:cross_comp/screens/mainPageAfter/professionals/facilities/facilityParticipantSchedule.dart';
import 'package:cross_comp/utilities/constants.dart';
import 'package:cross_comp/utilities/size_config.dart';
import 'package:flutter/material.dart';

class FacilityManageParticipants extends StatefulWidget {
  FacilityManageParticipants({Key? key}) : super(key: key);

  @override
  _FacilityManageParticipantsState createState() =>
      _FacilityManageParticipantsState();
}

class _FacilityManageParticipantsState
    extends State<FacilityManageParticipants> {
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => FacilityParticipantSchedule(facilityId: idX,)));
        },
        child: Card(
