...
import 'package:cross_comp/screens/mainPageAfter/professionals/facilities/facilityRegistration.dart';
...
class MyFacilities extends StatefulWidget {
  MyFacilities({Key? key}) : super(key: key);

  @override
  _MyFacilitiesState createState() => _MyFacilitiesState();
}

class _MyFacilitiesState extends State<MyFacilities> {
  ...
  Future<Map<String, dynamic>> deleteFacilityData(String facilityID) async {
    print("saveEventData");


    String url = mainApiUrl + "?delete_facility=true&Facility_ID=$facilityID";
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    deleteFacilityData(item["id"].toString());
                  },
                  child: Image.asset(
