...
class FacilityCheckIn extends StatefulWidget {
  String userId;
  String rId;
  FacilityCheckIn({required this.userId,required this.rId}) ;

  @override
  _FacilityCheckInState createState() => _FacilityCheckInState();
}

class _FacilityCheckInState extends State<FacilityCheckIn> {
  String fName = "Jon";
  String lName = "Opsahl";
