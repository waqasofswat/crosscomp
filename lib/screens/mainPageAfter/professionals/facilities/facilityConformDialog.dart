...
class FacilityConformDialog extends StatefulWidget {
  final Function() pressYes;
  final Function() pressNo;
  final String title;
  final String message;
  FacilityConformDialog(
  ...
  @override
  _FacilityConformDialogState createState() => _FacilityConformDialogState();
}

class _FacilityConformDialogState extends State<FacilityConformDialog>
