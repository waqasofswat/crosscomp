...
import 'package:cross_comp/screens/mainPageAfter/professionals/facilities/facilityJudgeSchedule.dart';
...
class _SelectFacilityState extends State<SelectFacility> {
  ...
  Future<Map<String, dynamic>> getFacilitiesData() async {
    ...
    _timimg.clear();
    String url = mainApiUrl + "?get_all_facility=true&isFree=0";
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => FacilityJudgeSchedule(fid:  item["id"].toString(),)));
          },
          child: Padding(
