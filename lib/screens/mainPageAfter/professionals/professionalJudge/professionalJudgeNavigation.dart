...
class ProfessionalJudgeNavigation extends StatefulWidget {
  ProfessionalJudgeNavigation({Key? key}) : super(key: key);

  @override
  _ProfessionalJudgeNavigationState createState() =>
      _ProfessionalJudgeNavigationState();
}

class _ProfessionalJudgeNavigationState
    extends State<ProfessionalJudgeNavigation> {
