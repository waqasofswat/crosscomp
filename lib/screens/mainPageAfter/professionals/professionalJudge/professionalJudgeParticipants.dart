...
class ProfessionalJudgeParticipants extends StatefulWidget {
  Map<String,dynamic> mapList;
  ProfessionalJudgeParticipants({Key? key,required this.mapList}) : super(key: key);

  @override
  _ProfessionalJudgeParticipantsState createState() =>
      _ProfessionalJudgeParticipantsState();
}

class _ProfessionalJudgeParticipantsState
    extends State<ProfessionalJudgeParticipants> with WidgetsBindingObserver {
                    ...
                    if (isGreen) {
                      if (!isShuttle) {
                        Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    ShuttleTestScreen(isProf: true,mapList: item,mapListOld: widget.mapList)));
                      } else if (!isSquarts) {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    SquartsTestScreen(isProf: true,mapList: item,mapListOld: widget.mapList,)));
                      } else if (!isLegRaise) {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    LegRaiseTestScreen(isProf: true,mapList: item,mapListOld: widget.mapList,)));
                      } else if (!isPushUps) {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    PushUpsTestScreen(isProf: true,mapList: item,mapListOld: widget.mapList,)));
                      } else {
