...
import 'package:cross_comp/screens/mainPageAfter/professionals/professionalJudge/professionalJudgeSignUp.dart';
...
class ProfessionalJudge extends StatefulWidget {

  ProfessionalJudge({Key? key}) : super(key: key);

  @override
  _ProfessionalJudgeState createState() => _ProfessionalJudgeState();
}

class _ProfessionalJudgeState extends State<ProfessionalJudge> {
  ...
  Future<Map<String, dynamic>> getFacilitiesData() async {
    ...
    // _event.clear();
    _facility.clear();
    String url = mainApiUrl + "?get_all_facility_professional_judge=true&userID=$userId";
          ...
          try{
            ...
            for(int i=0; i<fSize; i++){
              ...
              for(int x=0; x<fXSize; x++){
                ...
                String idX= map['mngr_response'][x]["Facility_ID"].toString();
                if(id==idX)
                  isManager=true;
              ...
              for (int i = 0; i < 7; i++) {
                ...
                String timing= map['server_response'][i]["monday_HB"].toString();
                    ...
                    infoWindow: InfoWindow(
                        ...
                        onTap: () {
                            ...
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ProfessionalJudgeSchedule()));
