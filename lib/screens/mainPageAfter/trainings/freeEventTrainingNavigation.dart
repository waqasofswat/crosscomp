...
class FreeEventTrainingNavigation extends StatefulWidget {
  FreeEventTrainingNavigation({Key? key}) : super(key: key);

  @override
  _FreeEventTrainingNavigationState createState() =>
      _FreeEventTrainingNavigationState();
}

class _FreeEventTrainingNavigationState
    extends State<FreeEventTrainingNavigation> {
