...
import 'package:cross_comp/screens/mainPageAfter/volunteer/volunteerJudge/volunteerJudgeNavigation.dart';
...
class VolunteerJudgeSchedule extends StatefulWidget {
  VolunteerJudgeSchedule({Key? key}) : super(key: key);

  @override
  _VolunteerJudgeScheduleState createState() => _VolunteerJudgeScheduleState();
}

class _VolunteerJudgeScheduleState extends State<VolunteerJudgeSchedule> {
            ...
            onTap: () {
              if (isStatus) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => VolunteerJudgeParticipants(mapList: item,)));
              }
            },
            child: Column(
              children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => VolunteerJudgeNavigation()));
            },
            child: Column(
              children: [
                Text(
