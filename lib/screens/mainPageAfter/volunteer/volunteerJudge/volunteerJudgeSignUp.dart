...
class VolunteerJudgeSignUp extends StatefulWidget {
  final Map<String, String> mapList;
  VolunteerJudgeSignUp({Key? key,required this.mapList}) : super(key: key);

  @override
  _VolunteerJudgeSignUpState createState() => _VolunteerJudgeSignUpState();
}

class _VolunteerJudgeSignUpState extends State<VolunteerJudgeSignUp> {
  ...
  Future<Map<String, dynamic>> saveAppointment() async {
    ...
    String url =
        mainApiUrl +
            "?add_judges_appointments=true&J_ID=$UserId&EF_ID=${widget.mapList['id']}&Type=${widget.mapList['type']}&Day=${widget.mapList['day']}&Date=${widget.mapList['date']}&Timing=${widget.mapList['timing']}&status=2";
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  Column(children: [
                    Text(
                      "You Can't Sign-Up to same event Again",
                      textAlign: TextAlign.center,
                      style: TextStyle(
