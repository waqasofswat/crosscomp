...
class VolunteerJudgeNavigation extends StatefulWidget {
  VolunteerJudgeNavigation({Key? key}) : super(key: key);

  @override
  _VolunteerJudgeNavigationState createState() =>
      _VolunteerJudgeNavigationState();
}

class _VolunteerJudgeNavigationState extends State<VolunteerJudgeNavigation> {
