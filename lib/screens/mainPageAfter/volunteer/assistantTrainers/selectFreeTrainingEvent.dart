...
import 'eventAssistantTrainingSchedule.dart';
import 'package:http/http.dart' as http;

class SelectFreeTrainingEvent extends StatefulWidget {
  SelectFreeTrainingEvent({Key? key}) : super(key: key);

  @override
  _SelectFreeTrainingEventState createState() =>
      _SelectFreeTrainingEventState();
}

class _SelectFreeTrainingEventState extends State<SelectFreeTrainingEvent> {
  ...
  Future<Map<String, dynamic>> getEventData() async {
    ...
    _timimg.clear();
    String url = mainApiUrl + "?get_all_event=true&isFree=1";
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => AssistantTrainerScheduleEvent(eid: item["id"].toString() )));
        },
        child: Card(
