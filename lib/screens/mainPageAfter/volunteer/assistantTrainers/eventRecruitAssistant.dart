...
class EventRecruitAssistant extends StatefulWidget {
  Map<String,dynamic> mapList;
  String title;
  EventRecruitAssistant({Key? key,required this.mapList,required this.title}) : super(key: key);

  @override
  _EventRecruitAssistantState createState() => _EventRecruitAssistantState();
}

class _EventRecruitAssistantState extends State<EventRecruitAssistant> {
  ...
  Future<Map<String, dynamic>> saveAssistance() async {
    ...
    print("day is $day");
    String date=widget.mapList["tmng"];
    print("date is $date");
    String selectedTimings=widget.mapList["date"];
