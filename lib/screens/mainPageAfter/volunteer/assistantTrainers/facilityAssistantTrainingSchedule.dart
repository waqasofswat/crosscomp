...
import 'package:cross_comp/screens/mainPageAfter/volunteer/assistantTrainers/facilityRecruitAssistant.dart';
...
class AssistantTrainerScheduleFacility extends StatefulWidget {
  String fid;
  AssistantTrainerScheduleFacility({Key? key, required this.fid}) : super(key: key);

  @override
  _AssistantTrainerScheduleFacilityState createState() =>
      _AssistantTrainerScheduleFacilityState();
}

class _AssistantTrainerScheduleFacilityState
    extends State<AssistantTrainerScheduleFacility> {
            ...
            try {
              ...
              for (int i = 0; i < size; i++) {
                ...
                if (indeX != -1) {
                  ...
                  _timimg.add({
                    "ef_id": map['ef_response']['Facility_ID'].toString(),
                    "ef_type": "facility",
                    "timing": tmng,
                    "trainee": participant,
                    "day": day,
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      FacilityRecruitAssistant(mapList: item,title: title,)));
                        },
                        child: Text(
                          "Recruit",
                          style: TextStyle(
