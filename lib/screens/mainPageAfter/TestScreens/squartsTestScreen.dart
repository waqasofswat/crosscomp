...
class SquartsTestScreen extends StatefulWidget {
  final bool isProf;
  Map<String, dynamic> mapList;
  Map<String, dynamic> mapListOld;
  SquartsTestScreen({Key? key, required this.isProf,required this.mapList,required this.mapListOld}) : super(key: key);

  @override
  _SquartsTestScreenState createState() => _SquartsTestScreenState();
}

class _SquartsTestScreenState extends State<SquartsTestScreen>
  ...
  Future<Map<String, dynamic>> saveExerciseScore() async {
    ...
    double finalVal= ((reps/120)*100)*gVal;
    print("gVal : $gVal");
    print("finalVal : $finalVal");
    String url = mainApiUrl +
        "?set_scores=true&ef_id=${widget.mapList["ef_id"]}&User_ID=${widget.mapList["uid"]}&date=${widget.mapList["date"]}&type=${widget.mapList["type"]}&squats=$finalVal&squatsGrade=$gradeVal";
