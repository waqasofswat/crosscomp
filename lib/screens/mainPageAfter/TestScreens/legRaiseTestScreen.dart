...
class LegRaiseTestScreen extends StatefulWidget {
  final bool isProf;
  Map<String, dynamic> mapList;
  Map<String, dynamic> mapListOld;
  LegRaiseTestScreen({Key? key, required this.isProf,required this.mapList,required this.mapListOld}) : super(key: key);

  @override
  _LegRaiseTestScreenState createState() => _LegRaiseTestScreenState();
}

class _LegRaiseTestScreenState extends State<LegRaiseTestScreen>
  ...
  Future<Map<String, dynamic>> saveExerciseScore() async {
    ...
    double finalVal= ((legRaise/60)*100)*gVal;
    print("gVal : $gVal");
    print("finalVal : $finalVal");
    String url = mainApiUrl +
        "?set_scores=true&ef_id=${widget.mapList["ef_id"]}&User_ID=${widget.mapList["uid"]}&date=${widget.mapList["date"]}&type=${widget.mapList["type"]}&legRaise=$finalVal&legRaiseGrade=$gradeVal";
