...
class PushUpsTestScreen extends StatefulWidget {
  ...
  PushUpsTestScreen({Key? key, required this.isProf,required this.mapList,required this.mapListOld}) : super(key: key);

  @override
  _PushUpsTestScreenState createState() => _PushUpsTestScreenState();
}
...
class _PushUpsTestScreenState extends State<PushUpsTestScreen>
  ...
  Future<Map<String, dynamic>> saveExerciseScore() async {
    ...
    double finalVal= ((pushUps/30)*100)*gVal;
    print("gVal : $gVal");
    print("finalVal : $finalVal");
    String url = mainApiUrl +
        "?set_scores=true&ef_id=${widget.mapList["ef_id"]}&User_ID=${widget.mapList["uid"]}&date=${widget.mapList["date"]}&type=${widget.mapList["type"]}&pushUps=$finalVal&pushUpsGrade=$gradeVal";
