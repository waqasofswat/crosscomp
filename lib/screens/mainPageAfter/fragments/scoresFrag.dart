...
class ScoresFrag extends StatefulWidget {
  ScoresFrag({Key? key}) : super(key: key);

  @override
  _ScoresFragState createState() => _ScoresFragState();
}

class _ScoresFragState extends State<ScoresFrag> {
  String UserId = "";
  String UserName = "";
  bool isLoading = true;
  @override
